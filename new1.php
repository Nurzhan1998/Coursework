...
<body>
  <!--logo with the name of company at the top-->
    ...
    <?php
     ...
     <h2 class="City"> Your story </h2>
    <?php  
    // Pulling the data from images table
    while ($row = $result -> fetch_assoc()):?>
  <div class="container">
    <div class="row g-2">
      <div class="col-12">
        <div class="p-3 border bg-light">
          <h5> <a href="new1.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger">Delete the story</a> </h5> 
          <tr>
          <td><?php echo "<img height='150' width='170' src='uploads/".$row['image']."'>"; ?></td> 
